...
my_balance <- my_balance[-c(1, 2, 3, 4), ]
my_balance1[1,1]<-"Calories/Person/Day"
my_balance1[2,1]<-"Monthly Expenditure/Capita"
my_balance1[3,1]<-"Household Members"
my_balance1[4,1]<-"Total Savings"
my_balance1[5,1]<-"Household Head Education"
my_balance1[6,1]<-"Number of Adult Males"
...
**Answer: The coefficient of column 6 can be interpreted to mean that migrating causes consumption to increase by 391.193. The coefficient of column 7 can be interpreted to mean that after controlling for various household characteristics migrating causes and increase in consumption of 355.115**
