...
stargazer(list(first_stage1, first_stage2,first_stage_ITT), title="Regression of Migrant on Treatment Arm Indicators", type="html", se = list(first_stage$rse,first_stage2$rse,first_stage_ITT$rse))
